...
import { FacebookIcon, YoutubeIcon, ZaloIcon } from '~/components/Icons';
                ...
                <div className={cx('footer-top')}>
                    <div className="row">
                        <div className="l-2-4 col">
                            <div className={cx('footer-top__item')}>
                                ...
                                <div className={cx('footer-top-item__body')}>
                                    <Link to={'/'} className={cx('footer-top-item_body-link')}>
                        ...
                        <div className="l-2-4 col">
                            ...
                            <div className={cx('footer-top__item')}>
                                <h4 className={cx('footer-top-item__title')}> Chứng nhận bởi </h4>
                                <div className={cx('footer-top-item__body')}>
                                    <div className={cx('footer-top-item__body-row')}>
                                        <div>
                                            <img
                                                alt=""
                                                className={cx('footer-top-item__body-row-image')}
                        ...
                        <div className="l-2-4 col">
                            ...
                            <div className={cx('footer-top__item')}>
                                <h4 className={cx('footer-top-item__title')}> Dịch vụ giao hàng </h4>
                                <div className={cx('footer-top-item__body')}>
                                    <svg
                                        width="68"
                                        height="33"
                        ...
                        <div className="l-2-4 col">
                            <div className={cx('footer-top__item')}>
                                ...
                                <div className={cx('footer-top-item__body')}>
                                   <div className={cx('footer-top-item__body-row')}> 
                                        <Link to={'/'} className={cx('footer-top-item_body-link', 'icon')}>
                                           {<ZaloIcon />}
                                        </Link>
                                        <Link to={'/'} className={cx('footer-top-item_body-link', 'icon')}>
                                           {<FacebookIcon />}
                            ...
                            <div className={cx('footer-top__item')}>
                                <h4 className={cx('footer-top-item__title')}> Download app on your phone </h4>
                                <div className={cx('footer-top-item__body')}>
                                   <div className={cx('footer-top-item__body-row')}> 
                                        <img className={cx('qr-code')} alt ='' src={images.qrCode} >

                                        </img>
                                        <div className={cx('link-download')}>
                                            <img alt='' className={cx('link-download__store')} src = {images.appStore}>

                                            </img>
                                            <img alt='' className={cx('link-download__googlePlay')} src = {images.playGoogle}>
